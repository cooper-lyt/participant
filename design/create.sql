...
ALTER TABLE CONTRACT.HOUSE_SOURCE DROP FOREIGN KEY house_source_ibfk_1;
DROP INDEX CONTRACT ON CONTRACT.HOUSE_SOURCE;
ALTER TABLE CONTRACT.HOUSE_SOURCE DROP CONTRACT;


ALTER TABLE CONTRACT.COMPANY_SELL_INFO ADD SALE_CONTRACT VARCHAR(32) NULL;
